...
it('hoby_Box', () => {
  ...
  cy.get('[class="hobby__picture"]').should('have.attr','src','image/ika.JPG')
})
...
it('favorite_Box', () => {
  ...
  cy.get('[class="favorite-link__text"]').eq(0).contains('xxxx')
  cy.get('[class="favorite-link__text"]').eq(1).contains('xxxx')
